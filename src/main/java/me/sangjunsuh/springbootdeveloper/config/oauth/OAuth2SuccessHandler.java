package me.sangjunsuh.springbootdeveloper.config.oauth;
...
import me.sangjunsuh.springbootdeveloper.util.CookieUtil;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private void clearAuthenticationAttributes(HttpServletRequest request,
        ...
        authorizationRequestBasedOnCookieRepository.removeAuthorizationRequestCookies(request,
                response);
    }
    // 액세스 토큰을 패스에 추가
