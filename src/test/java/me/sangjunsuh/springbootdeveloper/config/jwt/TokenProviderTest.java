package me.sangjunsuh.springbootdeveloper.config.jwt;
...
class TokenProviderTest {
    ...
    @DisplayName("generateToken(): 유저 정보와 만료 기간을 전달해 토큰을 만들 수 있디.")
    @Test
    void generateToken() {
        // given
    ...
    @DisplayName("validToken(): 유효성 토큰인 때에 유효성 검증에 성공한다.")
    @Test
